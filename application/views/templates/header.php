        ...
        <aside id="sidebar">
            <div class="d-flex align-items-center">
                <button class="toggle-btn" type="button">
                    <i class="lni lni-dashboard-square-1 fs-3"></i>
                </button>
            ...
            <ul class="sidebar-nav">
                <li class="sidebar-item">
                    <a href="<?= base_url() ?>" class="sidebar-link d-flex align-items-center">
                ...
                <?php if ($login == True): ?>
                    ...
                    <?php if ($this->session->userdata('role') == 'admin'): ?>
                        <li class="sidebar-item">
                            <a href="<?= site_url('users') ?>" class="sidebar-link d-flex align-items-center">
